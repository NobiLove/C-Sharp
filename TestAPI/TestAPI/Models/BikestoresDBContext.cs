...
public partial class BikestoresDBContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:BikestoresDB");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27968C4BB5");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B46D864E72");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85C86EA9C4");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229BBE5050C");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D441C4452D");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5F8C0A8B2");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C028D305D");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164A80B6F13").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D322FDCA81");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C6B80C59F");
